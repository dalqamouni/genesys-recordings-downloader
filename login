...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="styles.06c2b7b062fc3f8a.css" media="print" onload="this.media='all'">
        <noscript>
            <link rel="stylesheet" href="styles.06c2b7b062fc3f8a.css">
        </noscript>
    </head>
    <body>
        <app-root></app-root>
        <script src="runtime.7ad5f7bf8708467c.js" type="module"></script>
        <script src="polyfills.8a51455821cd9b1e.js" type="module"></script>
        <script src="scripts.acf8e135a7b2e098.js" defer></script>
        <script src="main.d6c34cf212830774.js" type="module"></script>
    </body>
</html>
